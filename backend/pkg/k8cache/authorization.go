...
func parseAPIResourceRequest(apiPath string) (apiResourceRequest, bool) {
	...
	if parts[resourceIndex] == "namespaces" && len(parts) > resourceIndex+2 {
...
func getKubeVerb(r *http.Request) string {
...
func GetKindAndVerb(r *http.Request) (string, string) {
	...
	return request.resource, getKubeVerb(r)
}
